...
class employeeClass:
    def __init__(self,root):
        ...
        txt_contact=Entry(self.root,text="Contact",textvariable=self.var_contact,font=("goudy old style",15),bg="lightyellow").place(x=850,y=150,width=180) # type: ignore
...
#-------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    def add(self):
        ...
        try:
            if self.var_emp_id.get()=="":
                ...
                row=cur.fetchone()
                if row!=None:
                    messagebox.showerror("Error","This is Employee ID already assigned,try diffrent",parent=self.root)
                else:
    ...
    def get_data(self,ev):
        ...
        self.txt_address.insert(END,row[9]),# type:ignore
         ...
         try:
             if self.var_emp_id.get()=="":
                ...
                if row==None:
                    ...
                    con.commit()
                    messagebox.showinfo("Success","Employee Update sucessfully",parent=self.root)
                    self.show()
