...
class categoryClass:
    def __init__(self,root):
        ...
        self.category_table=ttk.Treeview(cat_frame,columns=("cid","name",),yscrollcommand=scrollx)# type:ignore
        ...
        #==images====
        self.im1=Image.open("images/cat.jpg")# type:ignore
        self.im1=self.im1.resize((500,250),Image.ANTIALIAS)# type:ignore
        self.im1=ImageTk.PhotoImage(self.im1)

        self.lbl_im1=Label(self.root,image=self.im1,bd=2,relief=RAISED)
        self.lbl_im1.place(x=50,y=220)

        self.im2=Image.open("images/category.jpg")# type:ignore
        self.im2=self.im2.resize((500,250),Image.ANTIALIAS)# type:ignore
        ...
        try:
            if self.var_name.get()=="":
                ...
                if row!=None:
                    ...
                    con.commit()
                    messagebox.showinfo("Success","category Addedd Sucessfully",parent=self) 
                    self.show()
