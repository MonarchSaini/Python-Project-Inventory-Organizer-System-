...
class productClass:
    def __init__(self,root):
        ...
        lbl_productname=Label(product_Frame,text="Name",font=("Goudy old style",15),bg="white").place(x=30,y=160)
 ...
 #-------------------------------------------------------------------------------------------------------------------------------------------------------------------
         ...
         try:
             if self.var_pid.get()=="":
                ...
                if row==None:
                    ...
                    con.commit()
                    messagebox.showinfo("Success","Product Update sucessfully",parent=self.root)
                    self.show()
    ...
    def clear(self):
         ...
         self.var_cat.set("Select"),# type:ignore
         self.var_sup.set("Select"),# type:ignore
         self.var_name.set(""),# type:ignore
         self.var_price.set(""),# type:ignore
         self.var_qty.set(""),# type:ignore
         self.var_status.set("ACTIVE"),# type:ignore
         self.var_pid.set("")
            ...
            if self.var_searchby.get()=="Select":
                ...
                if len(rows)!=0:
                   ...
                   for row in rows:
                    ...
                    messagebox.showerror("Error","No record found_-_-_-_-_-!!!!!",parent=self.root)       
