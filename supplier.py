...
#-------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    def add(self):
        ...
        try:
            if self.var_sup_invoice.get()=="":
                ...
                row=cur.fetchone()
                if row!=None:
                    messagebox.showerror("Error","This is Invoice no. already assigned,try diffrent",parent=self.root)
                else:
    ...
    def get_data(self,ev):
        ...
        self.txt_desc.insert(END,row[3]),# type:ignore
         ...
         try:
             if self.var_sup_invoice.get()=="":
                ...
                if row==None:
                    ...
                    con.commit()
                    messagebox.showinfo("Success","supplier Update sucessfully",parent=self.root)
                    self.show()
    ...
    def search(self):
        ...
        try:
            if self.var_searchtxt.get()=="":
                ...
                cur.execute("select * from supplier where invoice=? "(self.var_searchtxt.get(),))# type:ignore
                rows=cur.fetchone()
                if row!=None:# type:ignore
